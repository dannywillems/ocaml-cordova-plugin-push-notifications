# ocaml-cordova-plugin-push-notifications-example

This is an example of the binding to the *push notifications cordova plugin*. See the
binding
[here](https://github.com/dannywillems/ocaml-cordova-plugin-push-notifications)
...
* init_plugins: initialize plugins you need.
